...
public sealed class DiContainerGenerator : IIncrementalGenerator
{
        ...
        string registryName)
    {
        ...
        AppendMediator(builder, dashboard, mediatorClinicalEditor, mediatorClinicalReminder);
    ...
    private static void AppendMediator(StringBuilder builder, FeatureInfo? dashboard, FeatureInfo? clinicalEditor, FeatureInfo? clinicalReminder)
    {
        builder.AppendLine("    /// <inheritdoc />");
        ...
        if (dashboard is not null)
        {
            builder.AppendLine("            return NavigateDashboardPageAsync<TResponse>(pageKey, cancellationToken);");
        }
        else
        {
            builder.AppendLine("            return CreateResponse<TResponse>(pageKey, true);");
        }
        ...
        builder.AppendLine("            return CreateResponse<TResponse>(patientName, true);");
        builder.AppendLine("        }");
        builder.AppendLine();
        ...
        builder.AppendLine("            return CreateResponse<TResponse>(source + \":\" + action, true);");
        builder.AppendLine("        }");
        builder.AppendLine();
        ...
        FeatureInfo? quaternary)
    {
        ...
        builder.Append("CreateBusinessCompositePageViewModel(\"").Append(title).Append("\", \"")
            ...
            .Append(activeContext).Append("\", \"").Append(flowStatus).Append("\", ");
        builder.Append("Create").Append(primary.BaseName).Append("ViewModel(), ");
        builder.Append("Create").Append(secondary.BaseName).Append("ViewModel(), ");
        builder.Append("Create").Append(tertiary.BaseName).Append("ViewModel(), ");
        builder.Append("Create").Append(quaternary.BaseName).AppendLine("ViewModel()));");
    }
    ...
    private static void AppendBusinessPageFactory(StringBuilder builder, FeatureInfo? feature)
    {
        ...
        builder.AppendLine("        object primaryPanelViewModel,");
        builder.AppendLine("        object secondaryPanelViewModel,");
        builder.AppendLine("        object tertiaryPanelViewModel,");
        builder.AppendLine("        object quaternaryPanelViewModel)");
        builder.AppendLine("    {");
        ...
        builder.AppendLine("                summary,");
        builder.AppendLine("                primaryPanelViewModel,");
        builder.AppendLine("                secondaryPanelViewModel,");
        builder.AppendLine("                tertiaryPanelViewModel,");
        builder.AppendLine("                quaternaryPanelViewModel,");
