...
/// 表示游戏应用壳副作用分发器。
/// </summary>
public sealed class AppShellEffectDispatcher : MviEffectDispatcherBase<AppShellEffect>
{
    ...
    protected override ValueTask DispatchCoreAsync(AppShellEffect effect, CancellationToken cancellationToken)
    {
