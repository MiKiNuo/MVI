...
/// <summary>
/// 表示事件绑定搜索面板视图。
/// 通过 <see cref="AvaloniaEventSources.FromTextChanged"/> 把 <see cref="TextBox.TextChanged"/> 封装为
...
public sealed partial class EventBindingSearchPanelView : MviAvaloniaView<EventBindingSearchViewModel>
{
    ...
    protected override void OnBind(EventBindingSearchViewModel viewModel)
    {
        ...
        IEventSource<TextChangedEventArgs> source =
            AvaloniaEventSources.FromTextChanged(queryTextBox);
