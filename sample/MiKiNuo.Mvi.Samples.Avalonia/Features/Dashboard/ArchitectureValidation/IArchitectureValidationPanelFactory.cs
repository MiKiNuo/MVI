...
/// 由 <see cref="ArchitectureValidationViewModel.CreatePatientSearchViewModel(string)"/>、
/// <see cref="ArchitectureValidationViewModel.CreateAuditTimelineViewModel(string)"/> 等方法按需解析。
/// </para>
/// <para>
