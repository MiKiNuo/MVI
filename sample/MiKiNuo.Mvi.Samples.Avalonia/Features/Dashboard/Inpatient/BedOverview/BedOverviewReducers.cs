...
/// 表示床位总览 MVI规约器。
/// </summary>
public sealed partial class BedOverviewReducer
    : MviReducerBase<BedOverviewState, BedOverviewIntent, BedOverviewEffect>
{
    /// <summary>
    /// 处理主业务动作意图。
    /// </summary>
    ...
    [MviReduce]
    private MviReduceResult<BedOverviewState, BedOverviewEffect> Reduce(
