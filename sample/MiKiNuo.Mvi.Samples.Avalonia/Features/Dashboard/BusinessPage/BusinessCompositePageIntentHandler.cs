...
public sealed class BusinessCompositePageIntentHandler
    : MviIntentHandlerBase<BusinessCompositePageState, BusinessCompositePageIntent>
{
    ...
    protected override async ValueTask<BusinessCompositePageIntent?> HandleCoreAsync(
