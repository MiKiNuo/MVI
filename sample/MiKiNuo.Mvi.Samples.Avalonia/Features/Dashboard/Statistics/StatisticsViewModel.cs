...
public sealed partial class StatisticsViewModel
    : MviViewModelBase<StatisticsState, StatisticsIntent, UnitEffect>
{
    /// <summary>
    /// 初始化统计组件 ViewModel。
    /// </summary>
    ...
    public StatisticsViewModel(IMviStore<StatisticsState, StatisticsIntent, UnitEffect> store, IMviUiDispatcher? uiDispatcher = null)
