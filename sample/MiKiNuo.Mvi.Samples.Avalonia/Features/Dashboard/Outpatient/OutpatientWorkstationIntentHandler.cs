...
public sealed class OutpatientWorkstationIntentHandler
    : MviIntentHandlerBase<OutpatientWorkstationState, OutpatientWorkstationIntent>
{
    ...
    protected override async ValueTask<OutpatientWorkstationIntent?> HandleCoreAsync(
