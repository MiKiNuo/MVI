...
public sealed partial class UserProfileViewModel
    : MviViewModelBase<UserProfileState, UserProfileIntent, UnitEffect>
{
    /// <summary>
    /// 初始化用户信息组件 ViewModel。
    /// </summary>
    ...
    public UserProfileViewModel(IMviStore<UserProfileState, UserProfileIntent, UnitEffect> store, IMviUiDispatcher? uiDispatcher = null)
